...
class Mahasiswa extends CI_Controller {
	...
	public function index()
	{
		...
		$data['rundown'] = $this->db->query("SELECT tbrundown.*, linkrundown.link as linkRundown FROM tbrundown LEFT JOIN linkrundown ON tbrundown.idRundown = linkrundown.idRundown AND linkrundown.idKelBesar = '$idKelBesar' WHERE tbrundown.dateUse='$dateUse' ORDER BY idRundown")->result_array();
